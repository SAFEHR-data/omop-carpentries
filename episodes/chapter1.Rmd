...
OMOP CDM stands for the Observational Medical Outcomes Partnership Common Data Model. You do not really need to remember what OMOP stands for. Remembering that CDM stands for Common Data Model can help you remember that it is a data standard that can be applied to different data sources to create data in a 'Common' (same) format.
