...
Here is how we can plot a measurement (in this case blood pressure) over time for a patient. You may remember from a previous episode that numeric measurements are stored in the column `value_as_number`.
